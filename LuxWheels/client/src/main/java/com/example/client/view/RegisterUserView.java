...
public class RegisterUserView extends JFrame {
    ...
    private static RegisterUserView instance;
    ...
    private RegisterUserView() {
        ...
        URL carImageUrl = getClass().getResource("/aston.jpg");
    ...
    public static RegisterUserView getInstance() {
        if (RegisterUserView.instance == null) {
            RegisterUserView.instance = new RegisterUserView();
        }
        return RegisterUserView.instance;
    }

    public void closeWindow() {
        this.dispose();
        RegisterUserView.instance = null;
    }
